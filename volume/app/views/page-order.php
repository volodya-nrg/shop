    ...
    <div class="main_column">
        ...
        <form method="post" class="form" action="">
            <div class="form_row">
                ...
                <input type="email" name="<?php echo EnumField::Email->value ?>"
                       value="<?php echo $requestedEmail ?>"
                       required="required"/>
            </div>
            <div class="form_row">
                <div class="form_title">Номер телефона *</div>
                <input type="password" name="<?php echo EnumField::PhoneNumber->value ?>"
                       value="<?php echo $requestedPhoneNumber ?>"
                       required="required"/>
            </div>
            <div class="form_row">
            ...
            <div class="form_row">
                ...
                <input type="text" name="<?php echo EnumField::DeliveryTo->value ?>"
                       value="<?php echo $requestedDeliveryTo ?>"/>
            </div>
            <div class="form_row">
